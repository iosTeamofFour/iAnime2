...
public class GetPopularSketchTask extends CustomPostExecuteAsyncTask<Void, Void, MyFollowingListResponse> {
    private OkHttpClient okHttpClient;
    public  GetPopularSketchTask(TaskPostExecuteWrapper<MyFollowingListResponse> DoInPostExecute) {
